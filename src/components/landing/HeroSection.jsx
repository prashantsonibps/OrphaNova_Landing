...
export default function HeroSection({ onSeePlans, onTryDemo, theme }) {
  ...
  return (
    <div className="relative w-full h-screen flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 text-center">
        <div className="mt-32 max-w-7xl">
          <Badge className="bg-blue-600/20 text-blue-200 mt-8 mb-6 px-4 py-1.5 text-sm font-semibold rounded-full shadow sm:mb-8 sm:px-6 sm:py-2 sm:text-lg inline-flex items-center border transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 hover:bg-blue-600/30 border-blue-400/30">
      ...
      {/* Trusted by researchers logos removed as requested */}
    </div>);
