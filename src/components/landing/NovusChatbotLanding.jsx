...
export default function NovusChatbotLanding({ theme, isOpen: controlledIsOpen, onToggle }) {
          ...
          >
            ...
            <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 p-5 flex items-center justify-between">
              <div className="flex items-center gap-3">
                {/* Logo circle */}
                <div className="relative">
                  <div className="w-11 h-11 bg-white rounded-full flex items-center justify-center shadow-lg p-1.5">
                    <img 
                      src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/690a1389568b31dc5bffd62d/af115b481_OrphaNovaHealthcareStartupLogo4.png"
                      alt="Novus"
