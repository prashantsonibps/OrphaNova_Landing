      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative h-80 md:h-96 flex justify-center items-center">
            ...
            >
              {/* Inputs */}
              <motion.div variants={itemVariants()} className="absolute top-[15%] left-[5%] flex items-center gap-3 p-3 bg-white/80 backdrop-blur-sm rounded-lg shadow-md">
                <Database className="w-6 h-6 text-blue-500" /> <span className="font-medium">Raw Data</span>
              </motion.div>
              <motion.div variants={itemVariants()} className="absolute top-[55%] left-[10%] flex items-center gap-3 p-3 bg-white/80 backdrop-blur-sm rounded-lg shadow-md">
              ...
              {/* Outputs */}
              <motion.div variants={itemVariants(true)} className="absolute top-[20%] right-[0%] flex items-center gap-3 p-3 bg-white/80 backdrop-blur-sm rounded-lg shadow-md">
                <Lightbulb className="w-6 h-6 text-green-500" /> <span className="font-medium">Actionable Insights</span>
              </motion.div>
              <motion.div variants={itemVariants(true)} className="absolute top-[60%] right-[5%] flex items-center gap-3 p-3 bg-white/80 backdrop-blur-sm rounded-lg shadow-md">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="text-lg text-slate-600 max-w-xl mx-auto md:mx-0 space-y-6 leading-relaxed">
