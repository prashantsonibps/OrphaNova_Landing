...
export default function ProblemSection() {
  ...
  return (
    <motion.section 
      ref={ref}
      className="py-24 bg-gradient-to-br from-gray-50 via-slate-50 to-blue-50 relative overflow-hidden"
      initial={{ opacity: 0 }}
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.h2 
            className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-slate-900 via-red-700 to-orange-600 bg-clip-text text-transparent mb-6"
        ...
        >
          {problems.map((problem, index) => (
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
            >
              <Card className={`bg-gradient-to-br ${problem.bgGradient} border-2 border-white/60 hover:shadow-2xl transition-all duration-500 h-full overflow-hidden group backdrop-blur-sm`}>
